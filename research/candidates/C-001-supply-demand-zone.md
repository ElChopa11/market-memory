...
Any later study of C-001 must beat **that instrument's own trend-up** bracket rate, not the pooled ~33.3% coin-flip. VVVUSD is recorded on the same artifact as an interpretable outlier (dedicated look later; not a scan-gate).
