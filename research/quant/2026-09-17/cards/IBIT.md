...
- **Instrument:** IBIT (`IBIT`)
- **Review date:** 2026-09-17
- **Knowledge watermark (as_of_knowledge):** 2026-09-17T02:42:00+00:00
- **Track(s):** A, B
- **Sector:** crypto_equity
- **Benchmark:** BTC
- **Peers:** BTC, BTC_FUT, GLXY
- **Data-quality status:** ok
- **Labels:** none
- **Verdict:** INSUFFICIENT_DATA
- **Reason code(s):** RECLAIM_UNCONFIRMED, INSUFFICIENT_HISTORY, NO_MISPRICING, INADEQUATE_LIQUIDITY, DUPLICATE_BETA, CORRELATED_EXPOSURE, NO_CATALYST, THESIS_NOT_FALSIFIABLE
