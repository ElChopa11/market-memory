...
- **Instrument:** SAMSUNG (`SAMSUNGUSDT.F`)
...
- **Reason code(s):** RECLAIM_UNCONFIRMED, INSUFFICIENT_HISTORY, NO_MISPRICING, INADEQUATE_LIQUIDITY, NO_CATALYST, THESIS_NOT_FALSIFIABLE
