...
Desk operating model (private research lab, not a fund): [ops/desk-charters.md](ops/desk-charters.md), [ops/decision-rights.md](ops/decision-rights.md), [ops/improvement-queue.md](ops/improvement-queue.md), [docs/runbooks/desks.md](docs/runbooks/desks.md), [docs/runbooks/flow-desk.md](docs/runbooks/flow-desk.md), [docs/runbooks/macro-desk.md](docs/runbooks/macro-desk.md), [docs/runbooks/telegram.md](docs/runbooks/telegram.md), [docs/runbooks/llm-budget.md](docs/runbooks/llm-budget.md), [docs/runbooks/listings.md](docs/runbooks/listings.md), [docs/runbooks/scorecards.md](docs/runbooks/scorecards.md), [docs/runbooks/decay.md](docs/runbooks/decay.md), [docs/runbooks/base-rates.md](docs/runbooks/base-rates.md), [docs/playbook.md](docs/playbook.md). Hive roles in this file remain the permission constitution; desks are how work is assigned. **No desk overrides the Principal.** Execution & Fund Ops is future-only. Delivery (Telegram) is Ops-owned (Phase 5e + 6c fan-out). Decay watch is **Phase 6f** (IMP-031, Quant sleeve). Scorecards are **Phase 6e** (IMP-030 DONE #55, Quant sleeve). Listings/IPO is **Phase 6d** (IMP-017 DONE #54, Research sleeve).
