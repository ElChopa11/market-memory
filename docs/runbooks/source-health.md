...
| `missing_env` | `FRED_API_KEY`, `POSTGRES_DSN`, MinIO/S3 incomplete | no | Set env locally or in CI secrets. Never commit. See [market-pulse.md](market-pulse.md#fred_api_key-operators). |
...
See also: [ingest runbook](ingest.md), [Market Pulse runbook](market-pulse.md). Plan: [ops/plans/IMP-004-pulse-source-hardening.md](../../ops/plans/IMP-004-pulse-source-hardening.md).
