...
4. A green run prints `alembic_head=<revision>`, `migrated to <revision>`, and `SUCCESS: lab migrate exited 0`. A red run is a failed apply. On this tree the head is `0013_completion_per_run`.
