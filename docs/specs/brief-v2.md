...
- `LATE`, `DEADMAN`, and `CAPTURE` are appended in that order by `append_brief_status_lines` and stay at the end of the single message. Other PRs supply the DEADMAN and CAPTURE text.
