...
Postgres-backed migrate + fixture ingest + `what_did_we_know` replay + Market Pulse brief index + Phase 4 `research_run` / `paper_trade` + Phase 6a `desk_envelope` LISTEN/NOTIFY.
