"""Phase 6e queue hygiene: IMP-017 DONE #54, IMP-030 this PR, 6f parked, OPEN incidents stay OPEN."""
...
def test_queue_marks_017_done_030_in_review_031_parked() -> None:
    ...
    assert any("IMP-030" in line and "IN_REVIEW" in line for line in board_lines)
    assert any("IMP-031" in line and "PARKED" in line for line in board_lines)
...
def test_phase6e_plan_adr_and_config_exist() -> None:
    ...
    assert "watch_enabled: false" in decay
