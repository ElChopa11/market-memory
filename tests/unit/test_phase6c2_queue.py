"""Phase 6c-2 queue hygiene: IMP-018 DONE #49, IMP-019 this PR, 6d/6c-4/6c-5 parked."""
...
def test_queue_marks_018_done_019_in_review_parked_followons() -> None:
    ...
    assert any("IMP-019" in line and "IN_REVIEW" in line for line in board_lines)
    assert any("IMP-017" in line and "PARKED" in line for line in board_lines)
    assert any("IMP-020" in line and "PARKED" in line for line in board_lines)
