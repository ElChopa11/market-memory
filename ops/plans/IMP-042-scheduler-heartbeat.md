...
- Queue: IMP-040 DONE (#66). This item is **DONE** (#68). SCHED-001 stays OPEN (P0). Do not close on “no window yet”. IMP-046 holds the implementation slot (IMP-043 DONE #71).
