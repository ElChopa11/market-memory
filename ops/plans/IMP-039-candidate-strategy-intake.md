...
**Report status:** READY (validation studies parked; this PR lands the intake specs only).  
**Owner:** Quant  
**Scope:** Principal 2026-09-19 candidate shelf under `research/candidates/`. Owner QUANT. Status HYPOTHESIS. No sizing. No scan-gate. Quant validation studies stay READY — not `IN_PROGRESS`. IMP-024 keeps the implementation slot.
...
- `research/candidates/` with intake rules 1–7, C-001 / C-002 / C-003 (md + yaml), `failures/` archive.
...
- FRED / licence / KRX work from #60 is unchanged.
...
Revert this PR. `research/candidates/` disappears. IMP-034 (#60) and IMP-022 remain on main. No live path exists to unwind.
