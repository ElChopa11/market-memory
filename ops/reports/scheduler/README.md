...
| [2026-09-24-escalate-missing-actions-schedule.md](2026-09-24-escalate-missing-actions-schedule.md) | Principal house lesson 2026-09-24: escalate when the morning brief is still missing near the useful window. Run `35931476917` was a late schedule (Δ9120s), not a skip. #115 was not on `main` at 08:30 Sydney. |
