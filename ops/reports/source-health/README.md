...
Principal-local `--no-db` run (queue ELIGIBLE, not CLOSED): [2026-09-19.md](2026-09-19.md) + [2026-09-19.sha256](2026-09-19.sha256). FRED probe ok / credentials yes / yield not copied; Stooq `http_404` and object_store `missing_env` stay OPEN. Full-stack close requires Postgres + landed rows + resolvable provenance + a published value.
