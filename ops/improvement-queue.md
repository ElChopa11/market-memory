...
| **Dependencies** | After Monday 2026-09-21 unattended fire. IMP-016 / 6c-3 DONE (#47). IMP-056 holds the implementation slot. IMP-051 TV webhook ban stays (TV ref ≠ Chart webhook publisher). |
