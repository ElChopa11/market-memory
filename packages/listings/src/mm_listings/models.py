...
CARD_FOOTER = (
    "Research listings / IPO screen. Not a sixth desk. Not an order, fill, or execution approval. "
    "Quant owns R/sizing; listings inherits trade_math_hash and does not invent it. "
    "Closed Quant verdicts only. IC/Risk gates still required. UNTRADEABLE_AT_SIZE is observation only."
)
